...
app.get("/listarTrechos", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let resultadoConsulta = yield connection.execute(`SELECT TRECHOS.CODIGO, TRECHOS.NOME, ORIGEM.NOME AS ORIGEM, DESTINO.NOME AS DESTINO, AERONAVES.REFERENCIA AS AERONAVE
    FROM TRECHOS 
